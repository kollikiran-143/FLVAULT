...
public class AXISServiceImpl implements AXISService{
	...
	public BSInfo parseAXIS1(ParseBankStmtRequestDTO request) throws IOException {
		...
		try {
			...
			String[] arraytoStrings = CommonUtils.extractMultiGroupArray(text,
					"Statement.*Account\\s*No:\\s*(.+?)\\s+.*?From:\\s*(.*)To:\\s*(.*)\\)");
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS1: " + bankstatementInfo);
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS2: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
		log.info("Time Taken for AXISServiceImpl parseAXIS2 is: " + timeTaken);
		return bankstatementInfo;
	}
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS3: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
	...
	public BSInfo parseAXIS4(ParseBankStmtRequestDTO request) throws IOException {
		...
		try {
			...
			bankstatementInfo.setAddress(CommonUtils
					.extractMultiLinesField(text, "\\n(\\s*Registered\\s*Address[\\s\\S]*?)\\n\\s*Profile\\s*Complete", 75)
					.replaceAll("\\s*Registered\\s*", ""));
			bankstatementInfo.setIfsc(CommonUtils.extractField(text, "IFSC.*:\\s*(UTIB\\w{7})"));
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS4: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
	...
	public BSInfo parseAXIS5(ParseBankStmtRequestDTO request) {
		...
		try {
			...
			bankstatementInfo.setAddress(CommonUtils
					.extractMultiLinesField(text, "SCHEME\\s*CODE.*\\n([\\s\\S]*?)\\n\\s*Tran\\s*Date", 80));
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS5: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
	...
	public BSInfo parseAXIS6(ParseBankStmtRequestDTO request) {
		...
		try {
			...
			bankstatementInfo
					.setName(CommonUtils.extractField(text, "\\s*(.*?)Customer\\s*ID").replaceAll("\\s+", " ").trim());
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS6: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS7: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
...
//			e.printStackTrace();
		...
		log.info("Exiting AXISServiceImpl parseAXIS8: " + bankstatementInfo);
		long timeTaken = System.currentTimeMillis() - startTimeInMillis;
